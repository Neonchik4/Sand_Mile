...
class Conveyor(pygame.sprite.Sprite):
    # TODO: убрать всё к чертям, чтобы не мазолило глаз: ресурс на конвеере только один
...
coal = pygame.transform.scale(pygame.image.load('data/resources/coal.png'), (16, 16))
